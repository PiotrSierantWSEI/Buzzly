  ...
  return (
    <Sidebar>
      <SidebarContent>
        ...
        {itemsAuth && (<SidebarGroup className="group-data-[collapsible=icon]:hidden">
          <SidebarGroupLabel>Auth</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              {items.filter(i => i.group === 'auth').map((item) => (
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild>
                    <Link to={item.url}>
                      <item.icon />
        ...
        {itemsModeration && (<SidebarGroup className="group-data-[collapsible=icon]:hidden">
          <SidebarGroupLabel>Moderacja</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              {items.filter(i => i.group === 'moderacja').map((item) => (
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild>
                    <Link to={item.url}>
                      <item.icon />
        ...
        {itemsAdmin && (<SidebarGroup className="group-data-[collapsible=icon]:hidden">
          <SidebarGroupLabel>Auth</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
