    ...
    <div className="bg-background py-12 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 lg:gap-6">
          ...
          >
            <img
              src="https://imgs.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=600&auto=format&fit=crop"
          ...
          >
            <img
              src="https://imgs.unsplash.com/photo-1593642632823-8f785ba67e45?q=80&w=600&auto=format&fit=crop"
          ...
          >
            <img
              src="https://imgs.unsplash.com/photo-1625961332771-3f40b0e2bdcf?q=80&w=600&auto=format&fit=crop"
          ...
          >
            <img
              src="https://imgs.unsplash.com/photo-1544117519-31a4b719223d?q=80&w=600&auto=format&fit=crop"
