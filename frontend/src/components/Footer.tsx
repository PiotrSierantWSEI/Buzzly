  ...
  return (
    <footer className="border-ali/20 :px-4 mx-auto w-full border-b   border-t  px-2">
      <div className="relative mx-auto grid  max-w-7xl items-center justify-center gap-6 p-10 pb-0 md:flex ">
        ...
        <p className="text-center text-xs leading-4 md:text-left text-muted-foreground">
          Buzzly to nowoczesne, kompleksowe narzędzie stworzone z myślą o
          firmach, które chcą w pełni wykorzystać potencjał recenzji swoich
                  ...
                  >
                    {section.items.map((item) => (
                      <li key={item.name} className="flow-root">
                        <a
                          href={item.href}
                          className="text-sm md:text-xs hover:text-primary transition-all"
                        >
                          {item.name}
                        </a>
                      </li>
      ...
      <div className="flex flex-wrap justify-center gap-y-6">
        <div className="flex flex-wrap items-center justify-center gap-6 gap-y-4 px-6">
          <a
            ...
            target="_blank"
            className={
              'hover:-translate-y-1 border border-dotted rounded-xl p-2.5 transition-transform group'
            }
          >
            <Mail
              strokeWidth={1.5}
      ...
      <div className="mx-auto mb-10 mt-10 flex flex-col justify-between text-center text-xs md:max-w-7xl">
        <div className="flex flex-row items-center justify-center gap-1 text-muted-foreground">
          © {new Date().getFullYear()} Wykonane z{' '}
